...
import OverviewNotifition from "../../components/OverviewNotifition";

const { BsCameraFill, ImBin } = icons;

const CreatePostNotification = ({ isEdit }) => {
  ...
  return (
    <div className="px-6">
      <h1 className="text-3xl font-medium py-4 border-b border-gray-200">
        {isEdit ? "Chỉnh sửa bài đăng" : "Đăng thông báo"}
      </h1>
      <div className="flex gap-4">
        <div className="py-4 flex flex-col gap-8 flex-auto">
          ...
          {/* <div className="w-full mb-6">
            ...
            <small>Cập nhật hình ảnh rõ ràng sẽ nhanh hơn</small>
